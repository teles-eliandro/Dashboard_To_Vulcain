...
const DashboardVulcain = () => {
  ...
  const chemtechProjects = [
    { id: "PBR-09410", client: "PETROBRAS", title: "Centrale Thermique UTE SEPE TIARAJU", period: "2012 - 2014", role: "Support d'Ingénierie", tools: "PDMS, AutoCAD", details: "Modélisation complète multidisciplinaire (Civil, Équipements, Tuyauterie). Extraction et révision d'isométriques.", skills: ["Modélisation 3D", "Piping", "Isométriques"] },
    { id: "VAL-11601", client: "VALE", title: "Analyse Santé & Sécurité (HSE) São Luis", period: "2012 - 2014", role: "Support d'Ingénierie", tools: "Normes NR", details: "Élaboration de formulaires d'évaluation des risques et analyse de conformité selon les normes NR.", skills: ["HSE", "Audit", "Normes NR"] },
    { id: "CSN-13139", client: "CSN", title: "Expansion Phase 2 - Sidérurgie", period: "2014", role: "Support d'Ingénierie", tools: "AutoCAD, BOM", details: "Arrangements mécaniques et repositionnement d'équipements lourds. Élaboration de listes de matériels.", skills: ["Mécanique", "BOM", "Layout Design"] },
    ...
    { id: "VAL-13546", client: "VALE", title: "Système de Pompage Booster CMC", period: "2014", role: "Support d'Ingénierie", tools: "PDMS, Procurement", details: "Adéquation de routes de tuyauterie et supports spéciaux. Contact fournisseurs pour levée de prix.", skills: ["Piping", "Supports", "Procurement"] },
    { id: "LXS-11424", client: "LXS", title: "Dessins Mécaniques & Isométriques", period: "2014", role: "Support d'Ingénierie", tools: "AutoCAD", details: "Conception conceptuelle et de base pour dessins mécaniques complexes.", skills: ["Mécanique", "Conception"] }
    // Ajoute ici tes autres projets si nécessaire
  ];
